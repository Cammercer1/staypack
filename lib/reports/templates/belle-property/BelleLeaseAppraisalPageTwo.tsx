...
import { BELLE_BRAND } from "@/lib/branding/kits/belle";
import {
...
/** Belle lease page 2 — comps layout with branded header band. */
export function BelleLeaseAppraisalPageTwo({ report }: Props) {
  ...
  const accent = report.agency.primary_colour || BELLE_BRAND.statBar;
