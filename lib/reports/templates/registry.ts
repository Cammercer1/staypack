...
import {
  BoldSalesAppraisalTemplate,
  ClassicSalesAppraisalTemplate,
  EditorialSalesAppraisalTemplate,
  GallerySalesAppraisalTemplate,
  LandmarkSalesAppraisalTemplate,
  MinimalistSalesAppraisalTemplate,
  RefinedSalesAppraisalTemplate,
  SplitSalesAppraisalTemplate,
} from "@/lib/reports/templates/sales-appraisal/SalesAppraisalFamilyTemplates";
import {
...
export const REPORT_TEMPLATES: ReportTemplateDefinition[] = [
  ...
  },
  {
    ...
    tier: "detailed",
    label: "Classic",
    description: "Classic cover with sale price estimate; page 2 REA comparables.",
    pages: 2,
    sourcePath: "lib/reports/templates/classic",
    Component: ClassicSalesAppraisalTemplate,
  },
  {
    id: BOLD_SALES_APPRAISAL_TEMPLATE_ID,
    family: "bold",
    tier: "detailed",
    label: "Bold",
    description: "Bold hero layout with sale price callout; page 2 REA comparables.",
    pages: 2,
    sourcePath: "lib/reports/templates/bold",
    Component: BoldSalesAppraisalTemplate,
  },
  {
    id: GALLERY_SALES_APPRAISAL_TEMPLATE_ID,
    family: "gallery",
    tier: "detailed",
    label: "Gallery",
    description: "Photo-forward cover with sale estimate; page 2 REA comparables.",
    pages: 2,
    sourcePath: "lib/reports/templates/gallery",
    Component: GallerySalesAppraisalTemplate,
  },
  {
    id: EDITORIAL_SALES_APPRAISAL_TEMPLATE_ID,
    family: "editorial",
    tier: "detailed",
    label: "Editorial",
    description: "Magazine-style cover with sale price band; page 2 REA comparables.",
    pages: 2,
    sourcePath: "lib/reports/templates/editorial",
    Component: EditorialSalesAppraisalTemplate,
  },
  {
    id: SPLIT_SALES_APPRAISAL_TEMPLATE_ID,
    family: "split",
    tier: "detailed",
    label: "Split",
    description: "Split photo layout with sale estimate; page 2 REA comparables.",
    pages: 2,
    sourcePath: "lib/reports/templates/split",
    Component: SplitSalesAppraisalTemplate,
  },
  {
    id: REFINED_SALES_APPRAISAL_TEMPLATE_ID,
    family: "refined",
    tier: "detailed",
    label: "Refined",
    description: "Refined branded layout with sale estimate; page 2 REA comparables.",
    pages: 2,
    sourcePath: "lib/reports/templates/refined",
    Component: RefinedSalesAppraisalTemplate,
  },
  {
    id: MINIMALIST_SALES_APPRAISAL_TEMPLATE_ID,
    family: "minimalist",
    tier: "detailed",
    label: "Minimalist",
    description: "Minimal cover with sale estimate; page 2 REA comparables.",
    pages: 2,
    sourcePath: "lib/reports/templates/minimalist",
    Component: MinimalistSalesAppraisalTemplate,
  },
  {
    id: LANDMARK_SALES_APPRAISAL_TEMPLATE_ID,
    family: "landmark",
    tier: "detailed",
    label: "Landmark",
    description: "Landmark-style cover with sale estimate; page 2 REA comparables.",
    pages: 2,
    sourcePath: "lib/reports/templates/landmark",
